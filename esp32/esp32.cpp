...
#define WIFI_SSID "wifi名称"	 // 2.4G WiFi名称
#define WIFI_PASS "wifi密码" // 对应的WiFi密码
#define WEBSOCKET_SERVER "域名或ip" // Websocket服务器域名/IP地址
#define WEBSOCKET_PORT 2333 // Websocket服务端口
#define WEBSOCKET_PATH "/" // Websocket方法路由

U8G2_SSD1309_128X64_NONAME2_2_SW_I2C u8g2(U8G2_R0, /* SCL=*/ 5, /* SDA=*/ 18, /* RST=*/ U8X8_PIN_NONE); // 液晶屏引脚定义，此处用的液晶为ssd1309驱动
